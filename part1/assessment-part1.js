...
function daBears() {
  // access to only its own scope
  var isFurry = true;

  function papaBear() {
    // access to own scope and daBears
    ...
    function mamaBear() {
      // access to own scope, papaBear, and daBears
      var porridge = "Too Cold!";
      var bed = "Too Soft!";

      function babyBear() {
        // access to own scope, mamaBear, papaBear, and daBears
...
var fairyTale5 = ["papaBear", "mamaBear", "babyBear", "daBears"];
